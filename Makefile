...
sl0: sl0.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}
# sl00 actually a refined version
sl00: sl00.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}
sl1: sl1.c
	${CC} ${CFLAGS} -o $@ $^ ${SPECLIBS}
...
# an idea for random walks
sici0: sici0.cpp
	${CPP} ${CFLAGS} -o $@ $^ ${SPECINC3} ${SPECLIBS}
