/* grill3.c experimental not working. */
...
int main (int argc, char *argv[])
{
    ...
    for(i=0;i<2*hbarnums-1;i+=2) {
        cairo_arc(cr, secs[i]lb[vbarnums*ff].x + widthfracp, lb[vbarnums*ff].y, 5, 0, 2*M_PI);
