/*  pffff.. trying to get a hypothrocoid going */
...
#define NUMCOLS 1 /* number of colors to use */
...
//        cairo_arc(cr, 250*i/MAXREPROS, 30*i/MAXREPROS, 30, 0, 2 * M_PI);
        cairo_new_sub_path(cr);
        cairo_arc(cr, 20, 20, 30, 0, 2 * M_PI);
           cairo_restore(cr); // keep in
